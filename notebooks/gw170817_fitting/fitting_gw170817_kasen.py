...
model = ksm.Model('/home/kamile/ksm/data/metadata_kasen_bns.json',
                 '/home/kamile/ksm/models/kasen-bns-latent-10-hidden-500-CV-4-2021-04-17-epoch-200.pt',
                 filter_library_path='/home/kamile/ksm/data/filter_data',
                 observations=observations)


# fit using dynesty
dsampler = dynesty.NestedSampler(model.compute_likelihood_dynesty, model.prior_transform_kasen_dynesty, ndim=3) #ndim=4 for bulla model
...
try:
    ...
    pickle.dump(results, open('170817_results_with1sigma.p', 'wb'))
